                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="card-box">
                      ...
                      <form action="{{ url('courses/'.$edit_course->id) }}" enctype="multipart/form-data" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="card-body row">
                          ...
                          <div class="col-lg-6 p-t-20">
                            <div
                              ...
                              <input class="mdl-textfield__input" type="text" id="semester" name="course_semester" readonly
                                tabIndex="-1" value="{{$edit_course->course_semester}}">
                          ...
                          <div class="col-lg-6 p-t-20">
                            <div
                              class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                              <input class="mdl-textfield__input" type="text" id="credit" name="course_credit" value="{{$edit_course->course_credit}}">
                          ...
                          <div class="col-lg-6 p-t-20">
                            <div
                              class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                              <input class="mdl-textfield__input" type="text" id="txtTimeLength" name="course_hrs" value="{{$edit_course->course_hrs}}">
                          ...
                          <div class="col-lg-6 p-t-20">
                            <div
                              ...
                              <input class="mdl-textfield__input" type="text" id="course_teacher" name="course_teacher" readonly
                                tabIndex="-1" value="{{$edit_course->course_teacher}}">
                          ...
                          <div class="col-lg-6 p-t-20">
                              <div class="file-upload pb-2" style="border-bottom: 1px solid rgb(216, 216, 216)">
                                <img src="{{ url('storage/course_image/'.$edit_course->course_image) }}" class="img-fluid" style="width: 150px">
                          ...
                          <div class="col-lg-12 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield txt-full-width">
                              ...
                              <textarea class="ckeditor" rows="7" id="text7" name="course_details">{!!$edit_course->course_details!!}</textarea>
                            </div>
                          ...
                          <div class="col-lg-12 p-t-20 text-center">
                            <button type="submit"
                              class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-success">Update</button>
                              <a href="{{url()->previous()}}"
                              class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-danger">Cancel</a>
                          </div>
                        </div>
                      </form>
                    </div>
